...
class JaguarManager extends Entity {
    ...
    private static final double INITIAL_SPAWN_INTERVAL = 1.75;
    private static final double SPAWN_INTERVAL_MULTIPLIER = 0.9;
    private static final double SPAWN_INTERVAL_DECREASE_INTERVAL = 15;
    ...
    JaguarManager(Hunter pHunter, ScreenWhipe pScreenWhipe) {
    ...
    private void spawnJaguar() {
        ...
        EntityManager.getInstance().addEntity(new Jaguar(spawnX, spawnY, mHunter, mScreenWhipe));
    }
